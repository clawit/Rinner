/*--------------------------------------------------------------------------
* DynamicJson
* ver 1.2.1.0 (Aug. 17th, 2016) modified by KevinShen
...
namespace Rinner.Helper
{
    public class DynamicJson : DynamicObject
    {
        ...
        private static JsonType GetJsonType(object obj)
        {
            ...
            //modify by shy
            if (obj is Enum) return JsonType.@string;
            if (obj is Guid) return JsonType.@string;
            if (obj is EndPoint) return JsonType.@string;
